        ...
        <div class="joinmain">
            <div class="body2">
                ...
                <div class="join3">
                    ...
                    <div class="join3-2">
                        <table>
                            <tr>
                                ...
                                <td class="jointd">
                                    <input class="joinid" type="text" id="name" name="name" value="<%= u.getName()%>">
                                </td>
                             </tr>
                             <tr>
                                <th class="jointh">*이메일</th>
                                <td class="jointd">
                                    <input class="joinid" type="text" id="email" name="email" value="<%= u.getEmail()%>">
                                </td>
                             </tr>
                            <tr>
                                <th class="jointh">*아이디</th>
                                <td class="jointd">
                                    <input class="joinid" type="text" id="userid" name="userid" value="<%= u.getUserid()%>">
                                </td>
                             </tr>
                             <tr>
                                <th class="jointh">*비밀번호</th>
                                <td class="jointd">
                                    <input class="joinid" type="text" id="password" name="password" value="<%= u.getPassword()%>">
                                </td>
                             </tr>
                             ...
                             <tr>
                                ...
                                <td class="jointd">
                                    <input class="joinid" type="text" id="birth" name="birth" value="<%= u.getBirth()%>" >
                                </td>
                             </tr>
                             <tr>
                    ...
                    <div class="join3-3">
                        <span class="joinbtn1"><input type="submit" value="수정하기"/>
                        </span> 
                        <span class="joinbtn2">
                            <a href="" >취소</a>
                        </span> 
